...
const BASE = process.env.BASE ?? "/Users/admin/.cache/actuation/round5-experiments";
const BODY = process.env.BODY ?? "/Users/admin/.cache/actuation/glm-body.mjs";
...
function req(task, dir) {
  return { dir, request: {
    ...
    basis: { host_id: "rust-native-acceptance", host_revision: HOST_REVISION,
      benchmark_revision: process.env.BENCHMARK_LABEL ?? "series1-round5-accept-2026-09-17",
    ...
    run: { task_id: task, max_steps: 64, max_calls: 64, node: NODE,
      ...
      body: { fixture_provider: false, protocol: "one-shot-json",
        source_basis: { program: BODY, adapter: "one-shot-json/glm-body.mjs", provider: "zai", model: "glm-5.3-flash" },
        configuration: { provider: "zai", model: "glm-5.3-flash" },
        process: { program: NODE, args: [BODY], cwd: "/tmp",
