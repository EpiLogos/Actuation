...
actuation speech constitution [file|-] [--json]
actuation speech decision [file|-] [--json]
actuation speech interrupt [file|-] [--json]
actuation speech session [file|-] [--json]
actuation nara context [file|-] [--json]
actuation nara delegate [file|-] [--json]
actuation nara enrichment [file|-] [--json]
